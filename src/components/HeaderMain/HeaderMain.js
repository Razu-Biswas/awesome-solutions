        ...
        <div>
            ...
            <main style={{ height: '600px', marginTop: '200px', position: 'absolute' }} className="row d-flex align-items-center w-100">
                ...
                <div className="col-md-8 col-sm-8 col-8 ">
                    ...
                    <h1 className="text-white header-heading">Easy Solved <br /> fASTER  cOMMUNICATIONS</h1>
                    ...
                    <button className="btn  header-button" style={{color:'white', backgroundColor: 'yellow'}}> About More</button>
